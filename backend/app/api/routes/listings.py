...
def create_listing(payload: ListingCreate, session: SessionDep):
...
def update_listing(listing_id: int, payload: ListingUpdate, session: SessionDep):
...
def delete_listing(listing_id: int, session: SessionDep) -> None:
