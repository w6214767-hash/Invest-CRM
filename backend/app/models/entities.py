...
class SearchProfile(TimestampedModel, table=True):
    ...
    districts: list[str] = Field(default_factory=list, sa_column=Column(JSON, nullable=False))
    ...
    land_use: list[str] = Field(default_factory=list, sa_column=Column(JSON, nullable=False))
    exclude_words: list[str] = Field(default_factory=list, sa_column=Column(JSON, nullable=False))
    is_active: bool = Field(default=True)
